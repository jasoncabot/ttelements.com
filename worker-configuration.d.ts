/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9a2af6b36af66717fb4f8675f55aae39)
// Runtime types generated with workerd@1.20250410.0 2025-04-08 
declare namespace Cloudflare {
	interface Env {
		ACCESS_TOKENS: KVNamespace;
		SOCKET_TOKENS: KVNamespace;
		MAILGUN_RETURN_HOST: "https://ttelements.com" | "http://localhost:5173";
		MAILGUN_API_KEY: string;
		GAME: DurableObjectNamespace<import("./worker/index").Game>;
		USER: DurableObjectNamespace<import("./worker/index").User>;
		CARD_COLLECTION: DurableObjectNamespace<import("./worker/index").CardCollection>;
		ASSETS: Fetcher;
	}
}
